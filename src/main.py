...
[bold blue]
  _____              _                    _
 |  __ \            | |                  | |
 | |  | | __ _ _   _| |__  _ __ ___  __ _| | __
 | |  | |/ _` | | | | '_ \| '__/ _ \/ _` | |/ /
 | |__| | (_| | |_| | |_) | | |  __/ (_| |   <
 |_____/ \__,_|\__, |_.__/|_|  \___|\__,_|_|\_\
                __/ |
               |___/
[/bold blue]
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Daybreak - AI-Driven Information Aggregation System")
    ...
    try:
        ...
        try:
            ...
            console.print(
                "Run [bold cyan]uv run daybreak-wizard[/bold cyan] to launch the interactive setup wizard,\n"

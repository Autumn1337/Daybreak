...
class ContentAnalyzer:
    ...
    def __init__(self, ai_client: AIClient, language: str = "en"):
    ...
    async def _analyze_item(self, item: ContentItem) -> None:
        ...
        if self.language == "zh":
            system_prompt += "\n\nIMPORTANT: Write the 'summary' and 'reason' fields in Simplified Chinese (简体中文). Keep technical terms and proper nouns in English."
